...
\vspace{0.2cm}
\noindent\begin{tabular}{L{1.7cm}!{\color{gray}\vrule}l}
2020  & Situational Self Leadership\\
2020 & Microsoft Azure Administrator\\
2019 & DBS Problem Solving Practice\\
2018 & Docker for DevOps\\
2017 & Jenkins Professional\\
2016 & Cloud Computing with AWS\\
\end{tabular} 
...
\begin{tabularx}{\textwidth} { 
   ...
   >{\raggedright\arraybackslash}X 
   >{\raggedright\arraybackslash}X  }
Blogging & Entrepreneurship & Designing \\
Running & Cooking & Cricket
\end{tabularx}
