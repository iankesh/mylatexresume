...
% Enable below to justify text and use "\justify"
% \tolerance=1
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection {LNU,}{Ankesh \fontsize{20}{15}\selectfont [Sr. Associate - DevOps]}{{\urlstyle{same}\href{www.ankesh.co.in}{www.ankesh.co.in}}\\
...
%     EXPERIENCE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Professional Journey |  \bf\fontsize{10}{15}\selectfont Total - 8+ Years}
...
\location{2016 Feb – 2019 Apr | Chennai, IN \& Bengaluru, IN}
\sectionsep
...
\vspace{\topsep}
\vspace{\topsep}
\section{Total Experience |  \bf\fontsize{10}{15}\selectfont 8+ Years}
\runsubsection{Goldman Sachs}
\descript{| Senior Associate - DevOps | Sep 2021 - Present | Bengaluru, IN}
\location {{\bf ROLE:} Lead ( Team of 4 ), Team Contributor ( Team of 15 )}
\begin{tightemize}
%\justifying % to justify text
...
\descript{| SDE II - DevOps | Apr 2019 – Sep 2021 | Bengaluru, IN}
\location {{\bf ROLE:} Team Contributor ( Team of 8 )}
\begin{tightemize}
%\justifying % to justify text
...
\descript{| Software Engineer - DevOps | Feb 2016 – Apr 2019 | Chennai, IN \& Bengaluru, IN}
\location {{\bf ROLE:} Team Contributor ( Team of 21 ) \& Individual Contributor}
\begin{tightemize}
%\justifying % to justify text
